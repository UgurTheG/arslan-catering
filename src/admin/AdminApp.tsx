  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors text-left [hyphens:none]">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        <div className="absolute -top-48 -right-48 w-[700px] h-[700px] bg-gold/[0.03] dark:bg-gold/[0.06] rounded-full blur-3xl" />
        <div className="absolute -bottom-32 -left-32 w-[500px] h-[500px] bg-gold/[0.02] dark:bg-gold/[0.04] rounded-full blur-3xl" />
      </div>
            ...
            <div className="flex items-center gap-2.5">
              <div className="relative">
                ...
                <div className="relative w-7 h-7 overflow-hidden shadow-sm">
                  <img src="/favicon.svg" alt="Arslan Catering" className="w-full h-full" />
                </div>
              </div>
          ...
          <div className="mb-8">
            ...
            >
              <div className="relative rounded-2xl bg-white/70 dark:bg-gray-900/50 border border-gray-200/70 dark:border-gray-800/60 shadow-sm overflow-hidden mb-4">
                {/* Top accent stripe */}
                <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-gold via-gold/40 to-transparent" />
                {/* Background gradient wash */}
                <div className="absolute inset-0 bg-gradient-to-br from-gold/[0.04] via-transparent to-transparent dark:from-gold/[0.08] pointer-events-none" />
                <div className="relative flex items-center gap-4 px-5 py-4 sm:px-6 sm:py-5">
                  {/* Tab icon */}
                  <div className="relative shrink-0">
                    <div className="absolute inset-0 bg-gold/15 dark:bg-gold/20 rounded-2xl blur-md" />
                    <div className="relative w-12 h-12 rounded-2xl bg-gradient-to-br from-gold/12 to-gold/4 dark:from-gold/20 dark:to-gold/8 flex items-center justify-center text-gold ring-1 ring-gold/10 dark:ring-gold/20 shadow-sm">
