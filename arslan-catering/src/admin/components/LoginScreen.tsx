...
export default function LoginScreen() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row text-left [hyphens:none]">
      {/* Left branding panel */}
      <div className="hidden lg:flex lg:w-[420px] xl:w-[480px] shrink-0 flex-col justify-between p-10 xl:p-14 relative overflow-hidden bg-[#0a0a0a]">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(201,162,39,0.04)_1px,transparent_1px),linear-gradient(to_bottom,rgba(201,162,39,0.04)_1px,transparent_1px)] bg-[size:36px_36px]" />
        <div
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(to right, #c9a227, rgba(201,162,39,0.3), transparent)',
          }}
        />

        <div className="relative z-10">
          <div className="w-16 h-16 rounded-full bg-white flex items-center justify-center shadow-2xl mb-10">
            <span className="text-2xl font-black" style={{ color: '#c9a227' }}>
              AC
            </span>
          </div>
          ...
          <p className="text-gray-400 text-sm leading-relaxed max-w-[260px]">
            Inhalte bearbeiten, Fotos hochladen und Änderungen direkt auf arslan-catering.de
            veröffentlichen.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16 relative overflow-hidden bg-white dark:bg-gray-950">
        ...
        <div
          className="absolute -top-48 -right-48 w-[600px] h-[600px] rounded-full blur-3xl opacity-[0.04]"
        ...
        <button
          ...
          className="absolute top-4 right-4 w-9 h-9 rounded-xl bg-gray-100 dark:bg-gray-800/80 flex items-center justify-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
        >
        ...
        >
          <div className="flex items-center gap-3 mb-10 lg:hidden">
            ...
            <div>
              <p className="font-extrabold text-sm text-gray-900 dark:text-white">Daten-Editor</p>
              <p className="text-[10px] text-gray-400">Arslan Catering</p>
            </div>
          </div>
          ...
          {!CLIENT_ID ? (
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full bg-gray-950 dark:bg-white/8 hover:bg-gray-800 dark:hover:bg-white/12 text-white font-bold py-3.5 rounded-2xl transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:pointer-events-none shadow-lg hover:scale-[1.01] active:scale-[0.99]"
              >
                {loginLoading ? (
